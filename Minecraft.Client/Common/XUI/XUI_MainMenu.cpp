...
HRESULT CScene_Main::OnInit( XUIMessageInit* pInitData, BOOL& bHandled )
{
	...
	// Custom splash texts for Project: Online Legacy
	m_splashes.clear();
	// eSplashHappyBirthdayEx (index 0)
	m_splashes.push_back(L"Happy birthday, EX!");
	// eSplashHappyBirthdayNotch (index 1)
	m_splashes.push_back(L"Happy birthday, Notch!");
	// eSplashMerryXmas (index 2)
	m_splashes.push_back(L"Merry X-mas!");
	// eSplashHappyNewYear (index 3)
	m_splashes.push_back(L"Happy new year!");
	// eSplashRandomStart (index 4) - placeholder, skipped by random selection
	m_splashes.push_back(L"Project: Online Legacy");
	// Custom splashes (index 5+)
	m_splashes.push_back(L"Thank you for playing Project: Online Legacy");
	m_splashes.push_back(L"Anyone know why my toaster doesn't microwave properly?");
	m_splashes.push_back(L"Guys, Miiself didn't add Miis..");
	m_splashes.push_back(L"Wii would like to play");
	m_splashes.push_back(L"Notch.. please come back");
	m_splashes.push_back(L"DrPerky was not here, Miiself wrote this idk");
